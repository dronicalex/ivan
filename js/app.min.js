...
let sliderVertical = new Swiper('.page', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
// sliderVertical.mousewheel.disable()
let sliderHor = new Swiper('.page__wpp', {
	// 	/*
	// effect: 'fade',
	// 	autoplay: {
	// 		delay: 3000,
	...
	// 	*/
	speed: 1100,
	wrapperClass: 'page__wp',
	slideClass: 'screen__container',
	// 	// direction: 'vertical',
	slidesPerView: 1,
	// slidesPerView: 'auto',
	mousewheel: {
...
function setScrollType() {
	if (wrapper.classList.contains('_free')) {
		sliderVertical.params.freeMode = false
		wrapper.classList.remove('_free')
	}


	for (let index = 0; index < sliderVertical.slides.length; index++) {
		const slide = sliderVertical.slides[index];
		const slideContent = slide.querySelector('.screen__content')
		if (slideContent) {
			const slideContentHeiht = slideContent.offsetHeight
			console.log(slideContentHeiht)
			if (slideContentHeiht > window.innerWidth) {
				wrapper.classList.add('_free')
				sliderVertical.params.freeMode = true
				sliderVertical.mousewheel.disable()
				console.log('11')
			}
		}
...
if (window.innerWidth < 900) {
	sliderHor.mousewheel.disable()
	sliderHor.autoHeigth = true
}
